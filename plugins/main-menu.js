 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya FRBotz ><"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 FRBotz..."},
	]
    },{
...
┣╌ ⟪  Tᴏᴅᴀʏ  ⟫ 
┃    
┃▷  Wɪʙ : *${moment.tz('Asia/Jakarta').format('HH:mm:ss')}*
┃▷  Wɪᴛᴀ : *${moment.tz('Asia/Makassar').format('HH:mm:ss')}*
┃▷  Wɪᴛ : *${moment.tz('Asia/Jayapura').format('HH:mm:ss')}*
┃▷  Dᴀᴛᴇ : *${new Date().toLocaleDateString()}*
┢╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╼    
┣╌  ⟪ Dᴀᴛᴀʙᴀsᴇ ⟫ 
┃    
┃▷  Uᴘᴛɪᴍᴇ : ${mpt}
┃▷  Rᴇɢɪs :  *${Object.keys(global.db.data.users).length}*
┃▷  Uɴʀᴇɢ : *${Object.values(global.db.data.users).filter(user => user.registered == true).length}*
┃▷  Sɪsᴛᴇᴍ : *${os.platform()}*
┢╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╼
...
const listMessage = {
  text: tek,
  footer: 'Nᴏᴛᴇ!! : Jɪᴋᴀ Aɴᴅᴀ Mᴇɴᴇᴍᴜᴋᴀɴ Bᴜɢ/Eʀʀᴏʀ Bɪsᴀ Rᴇᴘᴏʀᴛ Dᴇɴɢᴀɴ Cᴀʀᴀ ▻ ketik #report',
  mentions: await conn.parseMention(tek),
  title: ``,
  buttonText: `𝕶𝖑𝖎𝖐 𝕸𝖊𝖓𝖚 𝕯𝖎𝖘𝖎𝖓𝖎 𝕶𝖆𝖐 ${tagnya}`,
  sections
}
  if (teks == '404') {
...
*/
	...
	return conn.sendButton(m.chat, bottime, text, `${imgr + 'Menu'}`, [["𝕽𝖊𝖋𝖊𝖗𝖆𝖑", _p + "ref"], ["𝕯𝖔𝖓𝖆𝖘𝖎", _p + "donasi"], ["𝕺𝖜𝖓𝖊𝖗", _p + "owner"]], m, {
        contextInfo: {
            externalAdReply: {
...
  } catch (e) { 
 ...
 let vn = `./mp3/PTT-20211218-WA0243.opus`
